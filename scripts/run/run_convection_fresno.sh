#!/usr/bin/env bash
# Make CONVECTION contribute. On data/fresno_variants/fresno (18 usable) we have REAL HRRR wind.
...
PY=.venv/bin/python
OUT="${OUT:-experiments/logs/convection}"
mkdir -p "$OUT"
...
wait
echo "=== CONVECTION SWEEP DONE (data/fresno_variants/fresno, HRRR wind, 8 seeds) ==="
